...
(
	array
	(
		"path"=> "blog.sqlite", //path to database file on server relative to phpliteadmin.php (this file you are editing)
		"name"=> "blog" 		//name of database to appear in application
	)
);
